...
public class Command
{
    ...
    /// </summary>
    internal static MethodDefinition GenerateReceiverInvokeHandler(TypeDefinition component, MethodDefinition rpc, MethodDefinition internalrpc)
    {
